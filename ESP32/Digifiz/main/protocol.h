...
typedef enum {
    ...
    PARAMETER_BRIGHTNESS_SIGNAL_MIN,        // 46
    PARAMETER_BRIGHTNESS_SIGNAL_MAX,        // 47
    PARAMETER_BRIGHTNESS_MIN,               // 48
    PARAMETER_BRIGHTNESS_MAX,               // 49
    PARAMETER_BRIGHTNESS_SPEED,             // 50
    PARAMETER_RPM_FILTER_FALLING,           // 51
