...
typedef enum {
    ...
    PARAMETER_EFFECT_TYPE,                  // 53
    PARAMETER_EFFECT_HUE,                   // 54
    PARAMETER_EFFECT_SATURATION,            // 55
    PARAMETER_EFFECT_VALUE,                 // 56
    PARAMETER_RPM_QUADRATIC_COEFFICIENT,    // 57
    PARAMETER_MANUAL_KL58B_SIGNAL_MIN,   // 58
    PARAMETER_MANUAL_KL58B_SIGNAL_MAX,   // 59
